...
def search_txt_files(path):
    num = 20200001    # 0001号便笺一定存在，因为之前已经建好了
    while True:
...
def main():
    ...
    add_notes_to_pic("windows.bmp", note_lines, "wallpaper.bmp")
